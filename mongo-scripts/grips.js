...
var categories = [];
var cursor1 = db.grip_categories.find().sort({_id: 1});
while(cursor1.hasNext()) {
    ...
    var packages = [];
    var cursor2 = db.grip_category_packages.find({package_category_id: obj1._id}).sort({_id: 1});
    while(cursor2.hasNext()) {
        ...
        var items = [];
        var cursor3 = db.grip_category_package_items.find({package_id: obj2._id}).sort({_id: 1});
...
function handleUrl(url) {
    ...
    var str = url
        .replace("https://images.hertz.com/content/dam/herc/hes/", "https://www.johnvincent.io/images/catalog/")
        .replace("https://images.hertz.com/herc/hes/", "https://www.johnvincent.io/images/catalog/");
    return str;
}
