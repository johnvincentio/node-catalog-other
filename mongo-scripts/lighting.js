...
var categories = [];
var cursor1 = db.lighting_categories.find().sort({_id: 1});
while(cursor1.hasNext()) {
    ...
    var packages = [];
    var cursor2 = db.lighting_category_packages.find({package_category_id: obj1._id}).sort({_id: 1});
    while(cursor2.hasNext()) {
        ...
        var items = [];
        var cursor3 = db.lighting_category_package_items.find({package_id: obj2._id}).sort({_id: 1});
